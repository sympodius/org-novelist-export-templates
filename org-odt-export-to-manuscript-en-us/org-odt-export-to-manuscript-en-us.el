...
(defun ooetmeu--get-file-property-value (file property)
        ...
        (with-temp-buffer
          ...
          (when (org-goto-first-child)
            ...
            (insert "#+BEGIN_EXPORT odt\n"
                    ...
                    (ooetmeu--get-file-property-value org-input-file "EMAIL")
          ...
          ;; Override verse blocks from standard Org ODT export.
          (goto-char (point-min))
          (let ((case-fold-search t)
            ...
            (while (re-search-forward "^[ \t]*#\\+begin_verse" nil t)
              ...
              (insert "</text:p>\n#+END_EXPORT\n")))
          ;; Override pagebreaks from standard Org ODT export. This still doesn't really do the right thing, but it's better than leaving the command visible in the final document.
          (goto-char (point-min))
          (let ((case-fold-search t))
